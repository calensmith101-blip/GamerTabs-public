...
export const GAMES = [
  ...
  { id: 'kingdom-conquest', title: 'Kingdom Conquest', icon: '🗺️', players: '2–6', type: 'Board', status: 'live', supportsOnline: true, supportsAI: true, supportsLocal: true, desc: 'Risk-style world conquest map game with territories, armies, dice battles and continent bonuses.' },
  { id: 'city-tycoon', title: 'City Tycoon', icon: '🏙️', players: '2–4', type: 'Board', status: 'live', supportsOnline: true, supportsAI: true, supportsLocal: true, desc: 'Monopoly-style South Adelaide property game.' },
